  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        // Se o usuário tem um curso, selecionar automaticamente
    ...
    <div className="space-y-6">
      <Card>
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-base font-semibold text-neutral-900 dark:text-[#E6EAF0]">Aulas</h1>
            <p className="text-sm text-neutral-600 dark:text-[#9CA3AF]">Veja o cronograma de aulas por curso.</p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
            ...
            {canManage && (
              <Button
                onClick={() => navigate('/lessons/new', { state: { courseId } })}
      ...
      {courseId ? (
        <LessonSchedule courseId={courseId} canManage={canManage} />
      ) : (
        <Card>
